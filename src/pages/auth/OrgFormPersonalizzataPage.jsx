...
/**
 * Creare un'organizzazione personalizzata.
 *
 ...
 */
export default function OrgFormPersonalizzataPage() {
  ...
  return (
    <>
      <PageShell title="Dati Organizzazione personalizzata" description="Crea un'organizzazione personalizzata — un gruppo o un clan. Viene generato un codice da condividere con i membri." />
      <div ref={formRef} style={{ padding: '0 2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem', maxWidth: 360, margin: '0 auto', width: '100%' }}>
        <input type="text" name="org-name" placeholder="Nome organizzazione (es. Clan Rossi)" style={inputStyle} />
