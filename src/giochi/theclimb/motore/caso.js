/**
 * Il caso, con un seme. Copia deliberata di quello di The Boss, che era a
 * sua volta copia di quello dell'arena.
 *
 * Sarebbe bastato importarlo, e sarebbe stato sbagliato: The Climb e' un
 * modulo isolato, e un gioco che importa un pezzo di un altro gioco lega
 * il destino dei due. Trenta righe duplicate costano meno di quella
 * dipendenza.
 *
 ...
 * che gioca diecimila partite, serve a «E se fossi nato altrove?» — che
 * e' la stessa partita rigiocata su un altro punto di partenza — e
 * servira' a un server che debba ricontrollare un punteggio.
 */
